               ...
               tabPanel(
                ...
                sidebarPanel(
                  ...
                  fluidRow(column(
                    ...
                    align = "center",
                    img(
                      src = "institute-for-deworming.png",
                      width = "50%",
                      height = "50%"
                    ),
                  )),
                  fluidRow(
                    ...
                    p(
                      ...
                      tags$li(
                        tags$a(href = "https://advocacy-policy-analysis.github.io/pa-dw-yes-opaque-link/", "A detailed report"),
                        "that describes how to obtain the policy estimate and describes each component of the analysis"
                      ),
                      tags$li(
                        tags$a(href = "https://github.com/advocacy-policy-analysis/pa-dw-yes-opaque-link", "A repository"),
